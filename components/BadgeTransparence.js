export default function BadgeTransparence({ generePar = true, verifiePar }) {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      {verifiePar && (
        <div className="inline-flex items-center gap-1 text-[0.62rem] font-mono text-papier/35 border border-ligne rounded-full px-2.5 py-1">
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="shrink-0">
